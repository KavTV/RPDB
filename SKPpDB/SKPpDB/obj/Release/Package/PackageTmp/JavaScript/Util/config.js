export default {
    "ProjectTable": {
        ...
        "BoxErrorElement": "<h6 style=\"font-size: 24px; color: red; text-align: center;\">Hov der var en fejl.<br>Har du husket at acceptere data'en <br><a href=\"https://api.projektdatabase.skprg.dk\">https://api.projektdatabase.skprg.dk</a></h6>",
    ...
    "StudentTable": {
        ...
        "SearchID": "searchbar",
        "BoxID": "TableList",
        "BoxErrorElement": "<h6 style=\"font-size: 24px; color: red; text-align: center;\"><br><a href=\"https://api.projektdatabase.skprg.dk\">https://api.projektdatabase.skprg.dk</a></h6>",
        "BoxLoadingElement": "<img src=\"Style/Image/loadingIcon.png\" class=\"loading\" alt=\"Loading ...\" /><h6 style=\"text-align: center;\"> Loading ... </h6>",
